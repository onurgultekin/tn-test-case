...
# Database: tn-test-case
# Generation Time: 2021-11-14 10:17:15 +0000
# ************************************************************
...
CREATE TABLE `devices` (
  ...
  CONSTRAINT `devices_app_id_foreign` FOREIGN KEY (`app_id`) REFERENCES `apps` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `subscriptions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `status` enum('Started','Renewed','Cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Started',
